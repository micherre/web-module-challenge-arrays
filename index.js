...
function removeFlavorByName(flavors, suffix){
  let index = flavors.indexof(name)
...
function copy(oGFlavors, newArray){
  oGFlavors.forEach(function(item) {
    newArray.push(item);
  });
...
let bjsRocks = []
console.log(copy(originalFlavors, bjsRocks));
